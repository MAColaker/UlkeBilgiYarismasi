...
public class Animasyon {
    ...
    public static void butonAnimasyonu(List<View> butonlar) {
    ...
    public static void titremeAnimasyonu(RelativeLayout soruBankasi) {
        AnimatorSet animatorSet=new AnimatorSet();
        ObjectAnimator animator = ObjectAnimator.ofFloat(soruBankasi,"translationX",-40,40,-30,30,-20,20,-10,10,0);
